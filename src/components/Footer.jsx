...
const Footer = () => {
  return (
    <div className='w-full h-screen bg-zinc-900 flex '>
        <div className=' w-1/2 h-full flex-col flex justify-between font-abc p-20  '>
            <div className='headings'> 
                <h1 className='text-[8vw] font-semibold uppercase leading-none  mb-1  '>Eye-</h1>
            <h1 className='text-[8vw] font-semibold uppercase leading-none mb-1 '>Opening</h1></div> 
        ...
        <div className='w-1/2 p-20 font-abc'>
        <h1 className='text-[6vw] font-semibold uppercase leading-none  mb-1'>presentations</h1>
        <div className='links font-Mont mt-10'>
            <h1 className='text-xl mb-5 '>S:</h1>
        ...
        <div className='links font-Mont mt-10'>
            <h1 className='text-xl mb-5 '>L:</h1>
            <a className='block text-lg font-light' href="#">202-1965 W 4th Ave</a>
            <a className='block text-lg font-light mb-3' href="#">Vancour, Canada</a>
            <a className='block text-lg font-light ' href="#">30 Chukarina St</a>
            <a className='block text-lg font-light' href="#">Lviv, Ukarine</a>


        </div>
        <div className='links font-Mont mt-10'>
            <h1 className='text-xl mb-5 '>E:</h1>
            <a className='block text-xl font-light ' href="#">hallo@ochi.design</a>
