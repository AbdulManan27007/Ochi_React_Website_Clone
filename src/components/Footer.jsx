    ...
    <div className="w-full h-screen bg-zinc-900 flex ">
      <div className=" w-1/2 h-full flex-col flex justify-between font-abc p-20  ">
        <div className="headings">
          <h1 className="text-[8vw] font-semibold uppercase leading-none  mb-1  ">
            Eye-
          </h1>
          <h1 className="text-[8vw] font-semibold uppercase leading-none mb-1 ">
            Opening
      ...
      <div className="w-1/2 p-20 font-abc">
        ...
        <div className="links font-Mont mt-10">
          ...
          <a className="block text-lg font-light" href="#">
            Facebook
          </a>
          <a className="block text-lg font-light" href="#">
            Instagram
        ...
        <div className="links font-Mont mt-10">
          ...
          <a className="block text-lg font-light mb-3" href="#">
            Vancour, Canada
          </a>
          <a className="block text-lg font-light " href="#">
            30 Chukarina St
