  ...
  return (
    <div className="eyes w-full h-screen overflow-hidden">
      <div
        ...
        data-scroll-section
        data-scroll-speed="-.7"
        className='w-full h-full bg-cover bg-center relative bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg")]'
      >
        <div className="absolute left-1/2 flex gap-10 top-1/2 -translate-x-[50%] -translate-y-[50%] w-1/3  ">
          <div className="w-[15vw] h-[15vw] flex  bg-zinc-100 rounded-full justify-center items-center ">
            <div className="w-2/3 h-2/3 rounded-full bg-zinc-900 relative flex justify-center items-center">
              <div className="text w-full h-10 text-center font-Mont font-semibold tracking-[0.2vw] text-zinc-300 uppercase text-xl ">
                Play
                <div
                  style={{
